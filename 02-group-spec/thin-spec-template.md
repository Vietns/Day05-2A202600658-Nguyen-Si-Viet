...
|---|---|---|
| Trần Quang Huy - 2A202601010 | Research / evidence | Screenshot self-use, review Google Play, ghi chú pain ngân sách. |
| Trương Hải Quân - 2A202600898 | SPEC | Pain statement, build slice, Auto/Aug decision, four paths. |
| Bùi Minh Hiếu - 2A202600876 | Prototype | UI cảnh báo ngân sách, mock data, logic tính dự báo. |
| Nguyễn Sĩ Việt - 2A202600658 | Test / failure path | Test happy, low-confidence, failure, correction; demo script. |
